...
module.exports = {
    ...
    MAX_POST_LEN: 4000,
    EMOJI_SIZE: 16,
    ONLINE_ICON_SVG: '<span class="glyphicon glyphicon-user" title="Online" style="color:#009933"></span>',
    OFFLINE_ICON_SVG: '<span class="glyphicon glyphicon-user" title="Offline" style="color:rgba(255,0,0,0.4)"></span>',
    ...
    THEMES: {
        default: {
            ...
            linkColor: 'rgb(101, 45, 134)',
            buttonBg: 'rgb(101, 45, 134)',
            buttonColor: '#FFFFFF'
        },
        defaultmattermost: {
            type: 'Mattermost',
